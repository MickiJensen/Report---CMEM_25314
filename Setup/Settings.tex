...
\newcommand{\dtulogocolour}{dtured} % Colour of the DTU logo: white, black or dtured
\newcommand{\frontpagetextcolour}{dtured} % front page text colour: white or black
\colorlet{frontbackcolor}{white} % Set the background colour of the front- and back page. Choose the colour so it matches the main colour of front page picture
